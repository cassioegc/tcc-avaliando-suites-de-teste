...
public class KeyValueTokenSecurityEvent_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.xml.security.stax.securityEvent.KeyValueTokenSecurityEvent"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(KeyValueTokenSecurityEvent_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(KeyValueTokenSecurityEvent_ESTest_scaffolding.class.getClassLoader()); 
