...
public class EncryptedKeyTokenSecurityEvent_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.xml.security.stax.securityEvent.EncryptedKeyTokenSecurityEvent"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(EncryptedKeyTokenSecurityEvent_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(EncryptedKeyTokenSecurityEvent_ESTest_scaffolding.class.getClassLoader()); 
