...
public class ContentEncryptedElementSecurityEvent_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.xml.security.stax.securityEvent.ContentEncryptedElementSecurityEvent"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ContentEncryptedElementSecurityEvent_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ContentEncryptedElementSecurityEvent_ESTest_scaffolding.class.getClassLoader()); 
