...
public class X509IssuerSerialSecurityToken_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.xml.security.stax.impl.securityToken.X509IssuerSerialSecurityToken"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(X509IssuerSerialSecurityToken_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(X509IssuerSerialSecurityToken_ESTest_scaffolding.class.getClassLoader()); 
