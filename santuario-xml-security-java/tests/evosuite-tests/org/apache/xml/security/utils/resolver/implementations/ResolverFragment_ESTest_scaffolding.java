...
public class ResolverFragment_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.xml.security.utils.resolver.implementations.ResolverFragment"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ResolverFragment_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.w3c.dom.Attr", false, ResolverFragment_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.w3c.dom.Document", false, ResolverFragment_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.w3c.dom.Element", false, ResolverFragment_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ResolverFragment_ESTest_scaffolding.class.getClassLoader()); 
