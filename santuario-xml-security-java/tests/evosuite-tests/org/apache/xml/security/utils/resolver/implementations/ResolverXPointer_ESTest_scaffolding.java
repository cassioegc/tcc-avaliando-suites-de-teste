...
public class ResolverXPointer_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.xml.security.utils.resolver.implementations.ResolverXPointer"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ResolverXPointer_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.w3c.dom.Attr", false, ResolverXPointer_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.w3c.dom.Document", false, ResolverXPointer_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.w3c.dom.Element", false, ResolverXPointer_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ResolverXPointer_ESTest_scaffolding.class.getClassLoader()); 
