...
public class SingleKeyResolver_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.xml.security.keys.keyresolver.implementations.SingleKeyResolver"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SingleKeyResolver_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.security.PrivateKey", false, SingleKeyResolver_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.security.PublicKey", false, SingleKeyResolver_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SingleKeyResolver_ESTest_scaffolding.class.getClassLoader()); 
