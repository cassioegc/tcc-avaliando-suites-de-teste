...
public class XMLCipherInput_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.xml.security.encryption.XMLCipherInput"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(XMLCipherInput_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.apache.xml.security.encryption.CipherData", false, XMLCipherInput_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.xml.security.encryption.CipherReference", false, XMLCipherInput_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.xml.security.encryption.CipherValue", false, XMLCipherInput_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.xml.security.encryption.EncryptedType", false, XMLCipherInput_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(XMLCipherInput_ESTest_scaffolding.class.getClassLoader()); 
