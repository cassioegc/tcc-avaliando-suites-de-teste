...
public class GovernancePermission_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.ibm.watson.data.client.model.GovernancePermission"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(GovernancePermission_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.ibm.watson.data.client.model.enums.GovernancePermissionAction",
      ...
      "com.ibm.watson.data.client.model.GovernancePermission",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GovernancePermission_ESTest_scaffolding.class.getClassLoader()); 
