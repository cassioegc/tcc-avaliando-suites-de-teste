...
public class GetUserResponse_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.ibm.watson.data.client.model.GetUserResponse"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(GetUserResponse_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.ibm.watson.data.client.model.GetUserResponse",
      ...
      "com.ibm.watson.data.client.model.ExtendedUserInfo",
      "io.netty.channel.DefaultChannelPipeline$1"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GetUserResponse_ESTest_scaffolding.class.getClassLoader()); 
