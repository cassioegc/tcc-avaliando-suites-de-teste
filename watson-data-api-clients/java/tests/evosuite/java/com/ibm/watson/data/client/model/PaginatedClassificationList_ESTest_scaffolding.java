...
public class PaginatedClassificationList_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.ibm.watson.data.client.model.PaginatedClassificationList"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PaginatedClassificationList_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.ibm.watson.data.client.model.PaginatedClassificationList",
      ...
      "com.ibm.watson.data.client.model.ResponseClassification",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PaginatedClassificationList_ESTest_scaffolding.class.getClassLoader()); 
