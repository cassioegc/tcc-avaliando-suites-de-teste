...
public class UserTaskActionPayload_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.ibm.watson.data.client.model.UserTaskActionPayload"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(UserTaskActionPayload_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.ibm.watson.data.client.model.FormPropertyInput",
      "io.netty.buffer.ByteBuf",
      "io.netty.util.internal.shaded.org.jctools.queues.atomic.LinkedQueueAtomicNode",
      "com.ibm.watson.data.client.model.enums.UserTaskAction",
      ...
      "com.ibm.watson.data.client.model.UserTaskActionPayload",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(UserTaskActionPayload_ESTest_scaffolding.class.getClassLoader()); 
