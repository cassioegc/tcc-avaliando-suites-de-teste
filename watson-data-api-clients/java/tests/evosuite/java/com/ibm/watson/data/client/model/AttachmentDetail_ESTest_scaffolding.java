...
public class AttachmentDetail_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.ibm.watson.data.client.model.AttachmentDetail"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AttachmentDetail_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.ibm.watson.data.client.model.AttachmentDetail",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AttachmentDetail_ESTest_scaffolding.class.getClassLoader()); 
