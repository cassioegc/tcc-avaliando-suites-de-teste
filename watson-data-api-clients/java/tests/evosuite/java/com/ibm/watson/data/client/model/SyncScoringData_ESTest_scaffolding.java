...
public class SyncScoringData_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.ibm.watson.data.client.model.SyncScoringData"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SyncScoringData_ESTest_scaffolding.class.getClassLoader() ,
      "com.ibm.watson.data.client.model.InputDataArray",
      "com.ibm.watson.data.client.model.SyncScoringData"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SyncScoringData_ESTest_scaffolding.class.getClassLoader()); 
