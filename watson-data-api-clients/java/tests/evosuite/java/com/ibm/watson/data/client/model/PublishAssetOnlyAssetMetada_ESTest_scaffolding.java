...
public class PublishAssetOnlyAssetMetada_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.ibm.watson.data.client.model.PublishAssetOnlyAssetMetada"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PublishAssetOnlyAssetMetada_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.ibm.watson.data.client.model.PublishAssetOnlyAssetMetada",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PublishAssetOnlyAssetMetada_ESTest_scaffolding.class.getClassLoader()); 
