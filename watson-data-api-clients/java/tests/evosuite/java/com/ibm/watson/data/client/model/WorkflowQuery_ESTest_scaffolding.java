...
public class WorkflowQuery_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.ibm.watson.data.client.model.WorkflowQuery"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(WorkflowQuery_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.ibm.watson.data.client.model.WorkflowQuery",
      ...
      "com.ibm.watson.data.client.model.enums.QueryConditionType",
      ...
      "com.ibm.watson.data.client.model.QueryCondition",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(WorkflowQuery_ESTest_scaffolding.class.getClassLoader()); 
