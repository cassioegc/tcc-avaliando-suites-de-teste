...
public class JobPostBody_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.ibm.watson.data.client.model.JobPostBody"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(JobPostBody_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.ibm.watson.data.client.model.JobPostBody",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(JobPostBody_ESTest_scaffolding.class.getClassLoader()); 
