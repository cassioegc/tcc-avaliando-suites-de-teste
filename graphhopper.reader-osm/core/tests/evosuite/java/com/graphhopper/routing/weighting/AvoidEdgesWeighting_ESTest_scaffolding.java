...
public class AvoidEdgesWeighting_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.routing.weighting.AvoidEdgesWeighting"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AvoidEdgesWeighting_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.graphhopper.routing.weighting.Weighting", false, AvoidEdgesWeighting_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.util.EdgeIteratorState", false, AvoidEdgesWeighting_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AvoidEdgesWeighting_ESTest_scaffolding.class.getClassLoader()); 
