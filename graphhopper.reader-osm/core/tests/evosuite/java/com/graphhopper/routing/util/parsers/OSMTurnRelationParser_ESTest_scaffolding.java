...
public class OSMTurnRelationParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.routing.util.parsers.OSMTurnRelationParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OSMTurnRelationParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.graphhopper.routing.util.parsers.OSMTurnRelationParser",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OSMTurnRelationParser_ESTest_scaffolding.class.getClassLoader()); 
