...
public class LandmarkStorage_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.routing.lm.LandmarkStorage"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LandmarkStorage_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.graphhopper.routing.lm.LandmarkStorage$BlockedEdgesFilter",
      ...
      "com.graphhopper.routing.lm.LandmarkStorage$RequireBothDirectionsEdgeFilter",
      ...
      "com.graphhopper.routing.lm.LandmarkStorage$SimpleBlockedEdgesFilter",
      ...
      "com.graphhopper.routing.lm.LandmarkStorage$1",
      ...
      "com.graphhopper.routing.lm.LandmarkStorage$LandmarkExplorer$1",
      "com.carrotsearch.hppc.AbstractLongCollection",
      "com.graphhopper.routing.lm.LandmarkStorage$LandmarkExplorer$2",
      ...
      "com.graphhopper.routing.util.spatialrules.countries.GermanySpatialRule",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LandmarkStorage_ESTest_scaffolding.class.getClassLoader()); 
