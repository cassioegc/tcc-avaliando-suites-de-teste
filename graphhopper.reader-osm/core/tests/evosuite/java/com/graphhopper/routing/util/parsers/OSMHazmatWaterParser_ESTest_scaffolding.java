...
public class OSMHazmatWaterParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.routing.util.parsers.OSMHazmatWaterParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OSMHazmatWaterParser_ESTest_scaffolding.class.getClassLoader() ,
      "com.carrotsearch.hppc.LongArrayList",
      "com.graphhopper.routing.ev.EncodedValue",
      "com.graphhopper.routing.util.parsers.OSMHazmatWaterParser",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.graphhopper.reader.ReaderWay", false, OSMHazmatWaterParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.routing.ev.EncodedValueLookup", false, OSMHazmatWaterParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.storage.IntsRef", false, OSMHazmatWaterParser_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OSMHazmatWaterParser_ESTest_scaffolding.class.getClassLoader()); 
