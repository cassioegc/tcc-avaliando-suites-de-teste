...
public class QueryRoutingCHGraph_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.routing.querygraph.QueryRoutingCHGraph"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(QueryRoutingCHGraph_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.graphhopper.routing.querygraph.QueryRoutingCHGraph$VirtualCHEdgeIterator",
      ...
      "com.graphhopper.routing.querygraph.QueryRoutingCHGraph$1",
      "com.graphhopper.storage.TurnCostStorage$TurnRelationIterator",
      "com.graphhopper.routing.querygraph.QueryRoutingCHGraph$2",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(QueryRoutingCHGraph_ESTest_scaffolding.class.getClassLoader()); 
