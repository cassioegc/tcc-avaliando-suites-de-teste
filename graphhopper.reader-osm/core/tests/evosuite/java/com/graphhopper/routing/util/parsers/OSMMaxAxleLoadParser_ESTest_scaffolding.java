...
public class OSMMaxAxleLoadParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.routing.util.parsers.OSMMaxAxleLoadParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OSMMaxAxleLoadParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.graphhopper.routing.util.parsers.OSMMaxAxleLoadParser",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.graphhopper.reader.ReaderWay", false, OSMMaxAxleLoadParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.routing.ev.DecimalEncodedValue", false, OSMMaxAxleLoadParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.routing.ev.EncodedValueLookup", false, OSMMaxAxleLoadParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.storage.IntsRef", false, OSMMaxAxleLoadParser_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OSMMaxAxleLoadParser_ESTest_scaffolding.class.getClassLoader()); 
