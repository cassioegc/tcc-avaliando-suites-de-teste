...
public class DefaultTurnCostProvider_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.routing.weighting.DefaultTurnCostProvider"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DefaultTurnCostProvider_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.graphhopper.storage.TurnCostStorage$Itr",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.graphhopper.routing.ev.DecimalEncodedValue", false, DefaultTurnCostProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.routing.util.FlagEncoder", false, DefaultTurnCostProvider_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.storage.TurnCostStorage", false, DefaultTurnCostProvider_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DefaultTurnCostProvider_ESTest_scaffolding.class.getClassLoader()); 
