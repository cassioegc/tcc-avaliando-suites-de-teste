...
public class OSMMaxHeightParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.routing.util.parsers.OSMMaxHeightParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OSMMaxHeightParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.graphhopper.routing.util.parsers.OSMMaxHeightParser",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.graphhopper.reader.ReaderWay", false, OSMMaxHeightParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.routing.ev.DecimalEncodedValue", false, OSMMaxHeightParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.routing.ev.EncodedValueLookup", false, OSMMaxHeightParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.storage.IntsRef", false, OSMMaxHeightParser_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OSMMaxHeightParser_ESTest_scaffolding.class.getClassLoader()); 
