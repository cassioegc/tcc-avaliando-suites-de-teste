...
public class OSMRoadClassLinkParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.routing.util.parsers.OSMRoadClassLinkParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OSMRoadClassLinkParser_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.graphhopper.reader.ReaderWay", false, OSMRoadClassLinkParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.routing.ev.EncodedValueLookup", false, OSMRoadClassLinkParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.storage.IntsRef", false, OSMRoadClassLinkParser_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OSMRoadClassLinkParser_ESTest_scaffolding.class.getClassLoader()); 
