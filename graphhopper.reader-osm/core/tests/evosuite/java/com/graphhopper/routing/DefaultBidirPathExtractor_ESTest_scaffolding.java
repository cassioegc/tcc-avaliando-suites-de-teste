...
public class DefaultBidirPathExtractor_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.routing.DefaultBidirPathExtractor"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DefaultBidirPathExtractor_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.graphhopper.routing.SPTEntry", false, DefaultBidirPathExtractor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.routing.weighting.Weighting", false, DefaultBidirPathExtractor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.storage.Graph", false, DefaultBidirPathExtractor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.storage.NodeAccess", false, DefaultBidirPathExtractor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.util.EdgeIteratorState", false, DefaultBidirPathExtractor_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DefaultBidirPathExtractor_ESTest_scaffolding.class.getClassLoader()); 
