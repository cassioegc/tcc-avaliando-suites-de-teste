...
public class ViaRouting_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.routing.ViaRouting"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ViaRouting_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.graphhopper.routing.DirectionResolver$Edge",
      ...
      "com.graphhopper.routing.DirectionResolver$AdjacentEdges",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ViaRouting_ESTest_scaffolding.class.getClassLoader()); 
