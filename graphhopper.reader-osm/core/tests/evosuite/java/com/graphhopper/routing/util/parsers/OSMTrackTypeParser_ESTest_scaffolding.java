...
public class OSMTrackTypeParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.routing.util.parsers.OSMTrackTypeParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OSMTrackTypeParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.graphhopper.routing.util.parsers.OSMTrackTypeParser",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.graphhopper.reader.ReaderWay", false, OSMTrackTypeParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.routing.ev.EncodedValueLookup", false, OSMTrackTypeParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.graphhopper.storage.IntsRef", false, OSMTrackTypeParser_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OSMTrackTypeParser_ESTest_scaffolding.class.getClassLoader()); 
