...
public class LocationIndexTree_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.storage.index.LocationIndexTree"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LocationIndexTree_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.graphhopper.storage.index.LocationIndexTree$InMemLeafEntry",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.graphhopper.storage.index.LocationIndex$Visitor", false, LocationIndexTree_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LocationIndexTree_ESTest_scaffolding.class.getClassLoader()); 
