...
public class GHLongObjectHashMap_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.coll.GHLongObjectHashMap"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(GHLongObjectHashMap_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.graphhopper.coll.GHLongObjectHashMap",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.carrotsearch.hppc.HashOrderMixingStrategy", false, GHLongObjectHashMap_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GHLongObjectHashMap_ESTest_scaffolding.class.getClassLoader()); 
