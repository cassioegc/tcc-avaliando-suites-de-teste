...
public class GHTBitSet_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.coll.GHTBitSet"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(GHTBitSet_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.graphhopper.coll.GHIntHashSet", false, GHTBitSet_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.Iterator", false, GHTBitSet_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GHTBitSet_ESTest_scaffolding.class.getClassLoader()); 
