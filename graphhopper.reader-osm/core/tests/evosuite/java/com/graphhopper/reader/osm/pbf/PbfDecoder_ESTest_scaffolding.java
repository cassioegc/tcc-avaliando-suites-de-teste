...
public class PbfDecoder_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.reader.osm.pbf.PbfDecoder"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PbfDecoder_ESTest_scaffolding.class.getClassLoader() ,
      "com.graphhopper.reader.osm.pbf.PbfDecoder$1",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.graphhopper.reader.osm.pbf.PbfStreamSplitter", false, PbfDecoder_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PbfDecoder_ESTest_scaffolding.class.getClassLoader()); 
