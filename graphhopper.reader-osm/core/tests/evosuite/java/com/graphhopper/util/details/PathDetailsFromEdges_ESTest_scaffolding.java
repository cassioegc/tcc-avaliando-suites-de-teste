...
public class PathDetailsFromEdges_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.util.details.PathDetailsFromEdges"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PathDetailsFromEdges_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.graphhopper.util.details.EdgeIdDetails",
      ...
      "com.graphhopper.util.details.StreetNameDetails",
      ...
      "com.graphhopper.util.details.IntDetails",
      "com.graphhopper.routing.ev.Roundabout",
      "com.graphhopper.coll.GHLongIntBTree",
      "com.graphhopper.util.details.TimeDetails",
      ...
      "com.graphhopper.util.details.BooleanDetails",
      ...
      "com.graphhopper.util.details.EdgeKeyDetails",
      ...
      "com.graphhopper.util.details.EnumDetails",
      ...
      "com.graphhopper.util.details.StringDetails",
      ...
      "com.graphhopper.util.details.DistanceDetails",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PathDetailsFromEdges_ESTest_scaffolding.class.getClassLoader()); 
