...
public class Polygon_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.graphhopper.util.shapes.Polygon"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Polygon_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.graphhopper.util.PointList", false, Polygon_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.locationtech.jts.geom.Envelope", false, Polygon_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.locationtech.jts.geom.LineString", false, Polygon_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.locationtech.jts.geom.Polygon", false, Polygon_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Polygon_ESTest_scaffolding.class.getClassLoader()); 
