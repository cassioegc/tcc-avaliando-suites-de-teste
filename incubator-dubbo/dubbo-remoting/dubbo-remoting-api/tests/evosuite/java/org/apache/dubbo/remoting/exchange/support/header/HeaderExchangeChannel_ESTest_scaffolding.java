...
public class HeaderExchangeChannel_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.dubbo.remoting.exchange.support.header.HeaderExchangeChannel"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(HeaderExchangeChannel_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.concurrent.Callable", false, HeaderExchangeChannel_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.dubbo.remoting.exchange.support.Replier", false, HeaderExchangeChannel_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(HeaderExchangeChannel_ESTest_scaffolding.class.getClassLoader()); 
