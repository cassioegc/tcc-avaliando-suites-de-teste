...
public class HeaderExchangeClient_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.apache.dubbo.remoting.exchange.support.header.HeaderExchangeClient"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(HeaderExchangeClient_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.concurrent.ExecutorService", false, HeaderExchangeClient_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.apache.dubbo.remoting.Client", false, HeaderExchangeClient_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(HeaderExchangeClient_ESTest_scaffolding.class.getClassLoader()); 
