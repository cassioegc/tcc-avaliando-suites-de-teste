    ...
    public static Basic1DMatrix block(Matrix a, Matrix b, Matrix c, Matrix d) {
        ...
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < columns; j++) {
                extracted(rows, array, i, i, i < a.rows(), j < a.columns(), a.get(i, j));
                extracted(rows, array, i, i, i < a.rows(), j > a.columns(), b.get(i, j));
                extracted(rows, array, i, i, i > a.rows(), j < a.columns(), c.get(i, j));
                extracted(rows, array, i, i, i > a.rows(), j > a.columns(), d.get(i, j));
            }
        }
