...
public class OoPlaceMatrixByVectorMultiplication_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Consumer", false, OoPlaceMatrixByVectorMultiplication_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.matrix.functor.MatrixFunction", false, OoPlaceMatrixByVectorMultiplication_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.functor.VectorAccumulator", false, OoPlaceMatrixByVectorMultiplication_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.functor.VectorFunction", false, OoPlaceMatrixByVectorMultiplication_ESTest_scaffolding.class.getClassLoader()));
  }
