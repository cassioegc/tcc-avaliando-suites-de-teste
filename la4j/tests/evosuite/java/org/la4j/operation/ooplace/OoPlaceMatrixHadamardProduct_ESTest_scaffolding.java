...
public class OoPlaceMatrixHadamardProduct_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.la4j.operation.ooplace.OoPlaceMatrixHadamardProduct"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OoPlaceMatrixHadamardProduct_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.la4j.matrix.functor.MatrixProcedure", false, OoPlaceMatrixHadamardProduct_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OoPlaceMatrixHadamardProduct_ESTest_scaffolding.class.getClassLoader()); 
