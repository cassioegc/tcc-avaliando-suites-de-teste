...
public class CRSMatrix_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.la4j.matrix.sparse.CRSMatrix"; 
  ...
  public static void setSystemProperties() {
    ...
    java.lang.System.setProperty("user.dir", "/home/cassioegc/tcc/la4j"); 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CRSMatrix_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Enumeration", false, CRSMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, CRSMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.matrix.MatrixFactory", false, CRSMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.matrix.functor.MatrixAccumulator", false, CRSMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.matrix.functor.MatrixFunction", false, CRSMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.matrix.functor.MatrixProcedure", false, CRSMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.operation.MatrixVectorOperation", false, CRSMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.functor.VectorAccumulator", false, CRSMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.functor.VectorFunction", false, CRSMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.functor.VectorProcedure", false, CRSMatrix_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CRSMatrix_ESTest_scaffolding.class.getClassLoader()); 
