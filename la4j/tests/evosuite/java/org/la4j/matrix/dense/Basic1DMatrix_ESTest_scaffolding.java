...
public class Basic1DMatrix_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.la4j.matrix.dense.Basic1DMatrix"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Basic1DMatrix_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Enumeration", false, Basic1DMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, Basic1DMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.matrix.MatrixFactory", false, Basic1DMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.matrix.functor.MatrixAccumulator", false, Basic1DMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.matrix.functor.MatrixPredicate", false, Basic1DMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.functor.VectorAccumulator", false, Basic1DMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.functor.VectorFunction", false, Basic1DMatrix_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.functor.VectorProcedure", false, Basic1DMatrix_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Basic1DMatrix_ESTest_scaffolding.class.getClassLoader()); 
