...
public class Vector_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.la4j.Vector"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Enumeration", false, Vector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, Vector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.operation.VectorMatrixOperation", false, Vector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.operation.VectorOperation", false, Vector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.VectorFactory", false, Vector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.functor.VectorAccumulator", false, Vector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.functor.VectorFunction", false, Vector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.functor.VectorPredicate", false, Vector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.functor.VectorProcedure", false, Vector_ESTest_scaffolding.class.getClassLoader()));
  }
