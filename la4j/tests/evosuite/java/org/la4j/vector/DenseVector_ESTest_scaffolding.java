...
public class DenseVector_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.la4j.vector.DenseVector"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DenseVector_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Enumeration", false, DenseVector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Consumer", false, DenseVector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.operation.VectorMatrixOperation", false, DenseVector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.operation.VectorVectorOperation", false, DenseVector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.la4j.vector.functor.VectorPredicate", false, DenseVector_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DenseVector_ESTest_scaffolding.class.getClassLoader()); 
